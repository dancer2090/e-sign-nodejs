...
var g_CAs = "./data-custom/CAs.json"

/* Масив з шляхом до кореневих сертификатів ЦЗО та ЦСК */
// var g_CACerts = [
// 	"./data-custom/Ukraina/АЦСК ТОВ _Центр сертифікації ключів _Україна_.cer",
// 	"./data-custom/Ukraina/OCSP-сервер АЦСК ТОВ _Центр сертифікації ключів _Україна_.cer",
// 	"./data-custom/Ukraina/OCSP-сервер Центральний засвідчувальний орган.cer",
// 	"./data-custom/Ukraina/Центральний засвідчувальний орган.cer",
// 	"./data-custom/Ukraina/TSP-сервер АЦСК ТОВ _Центр сертифікації ключів _Україна_.cer",
// ];
var g_CACerts = [
	"./data-custom/Ukraina/crt2/ACSKUkr88d6.cer",
	"./data-custom/Ukraina/crt2/CA-ACSK_Ukraina-050514.cer",
	"./data-custom/Ukraina/crt2/CA-ACSKUkraina-011117.cer",
	"./data-custom/Ukraina/crt2/TSP-ACSKUkraina-011117.cer",
	"./data-custom/Ukraina/crt2/Ukraina-291112.cer",
	"./data-custom/Ukraina/crt2/Ukraina-TSP-291112.cer",
	"./data-custom/Ukraina/crt2/Ukraina8c8.cer",
];
...
var g_PKey = {
	filePath: "./data-custom/Ukraina/37209971_3078601354_DU200610171922.ZS2",	/* Шлях до файлу з ос. ключем */
	password: "******",			/* Пароль до файлу з ос. ключем */
  certificates: [			/* Масив з шляхами до файлів сертифікатів ос. ключа */
    "./data-custom/Ukraina/Товариство з обмеженою відповідальністю Ренджи Ізмаїл (Коморний Сергій Володимирович) Підписання.crt",
    "./data-custom/Ukraina/Товариство з обмеженою відповідальністю Ренджи Ізмаїл (Коморний Сергій Володимирович) Шифрування.crt",
	],
	CACommonName: "АЦСК ТОВ \"Центр сертифікації ключів \"Україна\"" /*Ім'я ЦСК, що видав сертифікат ос. ключа*/
};
